...
def recording_all_data():
    ...
    with open('data.txt','w') as file:
        for d in data:
            file.writelines(f"Name is {d['u_name']} \n");
            file.writelines(f"Email is {d['email']} \n");
            file.writelines(f"Password is {d['password']} \n");
            file.writelines(f"Phone is {d['phone']} \n");
            file.writelines(f'Age is {d["age"]} \n');
